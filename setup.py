...
url = 'https://github.com/pahaz/django-smart-collectstatic'
...
with open(path.join(here, 'smartcollectstatic', '__init__.py'), encoding='utf-8') as f:
    data = f.read()
...
setup(
    ...
    keywords='django smart collectstatic',
